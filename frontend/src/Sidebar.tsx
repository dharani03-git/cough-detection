...
import {
    ...
    ShieldCheck, Settings, Activity, Zap, Lock, ChevronRight
} from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ backendOnline }) => {
    const location = useLocation();

    return (
        <aside className="w-80 border-r border-white/5 bg-[#030712]/80 backdrop-blur-3xl flex flex-col p-8 gap-10">
